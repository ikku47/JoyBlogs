...
const BLOG = {
  ...
  THEME: 'heo', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，Welcome to Joyboy.ae',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Joyboy', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Joyboy', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://joyboy.ae/blog', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Joyboy.ae', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,email,twitter,telegram,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  COMMENT_GISCUS_LANG: process.env.NEXT_PUBLIC_COMMENT_GISCUS_LANG || 'en-US', // 你的 Giscus 語言 e.g 'en', 'zh-TW', 'zh-CN', 預設 'en'
