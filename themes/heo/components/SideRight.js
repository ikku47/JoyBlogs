  ...
  return (
    <div id="sideRight" className="hidden xl:block w-72 space-y-4 h-full">
      ...
      <div className="sticky top-20 space-y-4">
        ...
        <div
          className={
            'border dark:border-gray-700 dark:bg-[#1A1A1A] dark:text-white rounded-xl lg:p-6 p-4 hidden lg:block bg-white'
          }
        >
        ...
        {/* 标签和成绩 */}
        <Card className={'bg-white dark:bg-[#1A1A1A] dark:text-white'}>
