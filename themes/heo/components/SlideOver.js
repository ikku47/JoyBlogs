            ...
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              ...
              >
                <Dialog.Panel className="pointer-events-auto relative w-96 max-w-md">
                  ...
                  {/* 内容 */}
                  <div className="flex h-full flex-col overflow-y-scroll bg-white dark:bg-[#06030b] py-6 shadow-xl">
...
function Button({ title, url }) {
  return (
    <Link
      href={url}
      className={
        'duration-200 hover:text-white hover:shadow-md flex cursor-pointer justify-between items-center px-2 py-2 border dark:border-gray-600 bg-white hover:bg-blue-600 dark:bg-[#1A1A1A] rounded-lg'
      }
    >
      {title}
    </Link>
