    ...
    <div id="article-end">
      ...
      <section className="lg:hidden pt-8 text-gray-800 items-center text-xs md:text-sm flex flex-col m-1 ">
        ...
        <Link
          href={`/${next.slug}`}
          passHref
          className="cursor-pointer justify-between space-y-1 px-5 py-6 rounded-b-xl dark:bg-[#1A1A1A] border dark:border-gray-600 items-center dark:text-white flex flex-col w-full h-18 duration-200"
        >
      ...
      >
        <Link
          href={`/${next.slug}`}
          className="cursor-pointer drop-shadow-xl duration transition-all h-24 dark:bg-[#1A1A1A] border dark:border-gray-600 p-3 bg-white dark:text-gray-300 dark:hover:text-yellow-600 hover:text-white hover:font-bold hover:bg-blue-600 rounded-lg flex flex-col justify-between"
        >
