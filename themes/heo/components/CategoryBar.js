...
export default function CategoryBar(props) {
  ...
  return (
    <div
      id="category-bar"
      className={`flex flex-nowrap justify-between items-center h-12 mb-4 space-x-2 w-full lg:bg-white dark:lg:bg-[#1A1A1A]  
  ${border ? 'lg:border lg:hover:border dark:lg:border-gray-800 hover:border-indigo-600 dark:hover:border-yellow-600 ' : ''}  py-2 lg:px-2 rounded-xl transition-colors duration-200`}
    >
      ...
      <div id="category-bar-next" className="flex items-center justify-center">
        ...
        <Link
          href="/category"
          className="whitespace-nowrap font-bold text-gray-900 dark:text-white transition-colors duration-200 hover:text-indigo-600"
        >
