...
function Banner(props) {
  ...
  return (
    <div
      ...
      className="hidden xl:flex xl:flex-col group h-full bg-white dark:bg-[#1A1A1A] rounded-xl border dark:border-gray-700 mb-3 relative overflow-hidden"
    >
      ...
      >
        <div className="ml-12 -translate-x-32 group-hover:translate-x-0 duration-300 transition-all ease-in">
          <div className="text-7xl text-white font-extrabold">Get started.</div>
