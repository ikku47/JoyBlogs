  ...
  return (
    <>
      ...
      <div className="hidden lg:flex justify-between items-end mt-10 mb-5 font-medium text-black duration-500 dark:text-gray-300 py-3 space-x-2 overflow-x-auto">
        ...
        >
          <div className="relative w-24 h-10 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1A1A1A] border rounded-lg cursor-pointer group">
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* 跳转页码 */}
          <div className="bg-white hover:bg-gray-100 dark:hover:bg-yellow-600  dark:bg-[#1A1A1A]  h-10 border flex justify-center items-center rounded-lg group hover:border-indigo-600 transition-all duration-200">
            <input
              value={value}
            ...
            <div
              onClick={jumpToPage}
              className="cursor-pointer hover:bg-indigo-600  dark:bg-[#1A1A1A] dark:hover:bg-yellow-600 hover:text-white px-4 py-2 group-hover:px-2 group-hover:mx-1 group-hover:rounded bg-white"
            >
      ...
      <div className="lg:hidden w-full flex flex-row">
        ...
        <Link
          ...
          rel="prev"
          className={`${showPrev ? 'block' : 'hidden'} dark:text-white relative w-full flex-1 h-14 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1A1A1A] border rounded-xl cursor-pointer`}
        >
          {locale.PAGINATION.PREV}
        </Link>
        ...
        <Link
          ...
          rel="next"
          className={`${+showNext ? 'block' : 'hidden'} dark:text-white relative w-full flex-1 h-14 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1A1A1A] border rounded-xl cursor-pointer`}
        >
          {locale.PAGINATION.NEXT}
        </Link>
      </div>
